export default defineNuxtRouteMiddleware((to, from) => {
  ...
  const ROLE_URLS = {
    ...
    kasubag: ['/dashboard_kasubag', '/data_pengajuan_cuti_kasubag', '/pengajuan_cuti_acc_kasubag_umum', '/rekap_cuti_acc_kasubag', '/pengguna_kasubag'],
    sekretaris: ['/dashboard_sekretaris', '/data_pengajuan_cuti_sekretaris', '/pengajuan_cuti_acc_sekretaris', '/rekap_cuti_acc_sekretaris', '/pengguna_sekretaris'],
