      ...
      <div class="card1">
        <div class="card-body">
          ...
          <div class="d-inline-block">
            ...
            <a href="/data_pengajuan_cuti_pegawai" class="small-box-footer">Selengkapnya <i
      ...
      <div class="card1">
        <div class="card-body">
          ...
          <div class="d-inline-block">
            ...
            <a href="/data_rekap_cuti_pegawai" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-right"></i></a>
          </div>
          <span class="float-right display-5 opacity-5"><i class="mdi mdi-animation"></i></span>
        </div>
      </div>
