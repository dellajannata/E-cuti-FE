  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="card-pegawai">
        ...
        <NuxtLink class="btn btn-primary" to="/create_pengajuan_cuti_sekretaris"><i class="fa fa-plus"></i></NuxtLink>
      </div>
        ...
        <table class="table table-hover">
          ...
          <tbody>
            <tr v-for="(cuti, index) in  filteredCuti " :key="index">
              ...
              <td class="btn-action">
                <template
                  v-if="cuti.status != 'Selesai' && cuti.status != 'Ditolak Kadis'">
                  <NuxtLink :to="`../editCutiSekretaris_${cuti.id}`" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i>
                  </NuxtLink>
                </template>
                <template v-if="cuti.status != 'Selesai'">
