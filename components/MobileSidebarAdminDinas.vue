<template>
    <div class="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" data-bs-toggle="collapse" to="/data_pegawai_admin_dinas" aria-expanded="false"
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" data-bs-toggle="collapse" to="/data_pengajuan_cuti_admin_dinas" aria-expanded="false"
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" to="/data_rekap_cuti_admin_dinas">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="/pengguna_admin_dinas" aria-expanded="false" aria-controls="auth">
