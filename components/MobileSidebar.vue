<template>
    <div class="sidebar">
      <ul class="nav">
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" data-bs-toggle="collapse" to="/data_pegawai" aria-expanded="false"
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" data-bs-toggle="collapse" to="/data_pengajuan_cuti" aria-expanded="false"
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" to="/data_rekap_cuti">
            <i class="menu-icon mdi mdi-file-document"></i>
            <span class="menu-title">Rekap Cuti</span>
          </NuxtLink>
        </li>
        <li class="nav-item">
          <NuxtLink class="nav-link" to="/pengajuan_cuti_keseluruhan">
            <i class="menu-icon mdi mdi-file-document"></i>
            <span class="menu-title">Pengajuan Cuti Keseluruhan</span>
          </NuxtLink>
        </li>
        <li class="nav-item">
        ...
        <!-- <li class="nav-item">
              <NuxtLink class="nav-link" to="/pengajuan_cuti_acc_selesai">
                <i class="menu-icon mdi mdi-file-document"></i>
