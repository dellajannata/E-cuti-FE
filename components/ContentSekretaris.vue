        ...
        <div class="card1">
          <div class="card-body">
            ...
            <div class="d-inline-block">
              ...
              <a href="/pengajuan_cuti_acc_sekretaris" class="small-box-footer">More info <i class="fa fa-arrow-right"></i></a>
            </div>
    ...
    methods: {
      getDataPengajuanCuti() {
        ...
        axios.get('http://127.0.0.1:8000/api/pengajuan_cuti', {
          ...
          this.data_cuti = res.data.data.filter(data_cuti => data_cuti.status === "ACC Kasubag Umum" & data_cuti.status !== "Ditolak");
          this.rekap_cuti = res.data.data.filter(data_cuti => data_cuti.status === "ACC Sekretaris");
        }).catch(error => {
