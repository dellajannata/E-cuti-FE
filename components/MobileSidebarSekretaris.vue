<template>
    <div class="sidebar">
      <ul class="nav">
        <li class="nav-item">
          <NuxtLink class="nav-link" to="/dashboard_sekretaris">
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" data-bs-toggle="collapse" to="/data_pengajuan_cuti_sekretaris" aria-expanded="false"
        ...
        <li class="nav-item">
          <NuxtLink class="nav-link" to="/rekap_cuti_acc_sekretaris">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="collapse" href="/pengguna_sekretaris" aria-expanded="false" aria-controls="auth">
